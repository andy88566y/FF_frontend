...
def generate_1D_plot(model: dict, slith: float):
    ...
    indices = [entry["defect_id"] for entry in model.values()]
...
def app() -> None:
    ...
    dir_model_1 = st.text_input('Model 1', value='/mnt/fs0/minye/falsefilter_api_study/db_files/N3_M2-6_20240923_000532_m0.0.1.db', help='Your First Model Database Directory.')
