...
def app() -> None:
    ...
    lot_id = st.text_input("Lot ID", value='N3_M2-6_20240923_000532', help='Name of the lot of images to run inference on.', key='lot_id')
    output_dir = st.text_input("Output directory", value='/mnt/fs0/minye/falsefilter_api_study/inference_test', help='The directory to store the generated .lrf and .db files.', key='output_dir')
    db_path = st.text_input("DB path", value='/mnt/fs0/minye/falsefilter_api_study/inference_test/N3_M2-6_20240923_000532/N3_M2-6_20240923_000532_encrypted_model_14lots.db', help='The directory to store the generated .lrf and .db files.', key='db_path')
