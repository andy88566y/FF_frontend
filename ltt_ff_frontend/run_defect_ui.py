...
from ltt_ff_frontend.defect_ui import basetrain_api, finetuning_api, inference_api, inference_recipe_api, result_viewer, result_viewer_recipe, multilot_inference_api
...
if __name__ == "__main__":
    ...
    page_result_viewer_recipe = st.Page(result_viewer_recipe.app, url_path="result_viewer_recipe", title="Result Viewer Recipe", icon=":material/search_check_2:")
    page_inference_api = st.Page(inference_api.app, url_path="inference_api", title="Inference", icon=":material/content_paste_search:")
    page_inference_recipe_api = st.Page(inference_recipe_api.app, url_path="inference_recipe_api", title="Inference Recipe", icon=":material/content_paste_search:")
    ...
    pg = st.navigation([page_result_viewer, page_result_viewer_recipe, page_defect_review_gui, page_inference_api, page_inference_recipe_api, page_multilot_inference_api, page_finetuning_api, page_basetrain_api])

    st.set_page_config(page_title="Lasertec Defect Filter UI",
                       page_icon=":material/manufacturing:",
                       layout="wide", initial_sidebar_state="collapsed")

    st.sidebar.markdown("###### FF-FE v0.5.0")
