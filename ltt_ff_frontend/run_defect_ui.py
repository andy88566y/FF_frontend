...
from ltt_ff_frontend.defect_ui import defect_viz, inference_api, defect_dshbrd, finetuning_api
...
if __name__ == "__main__":
    ...
    pg = st.navigation([defect_viz, inference_api, finetuning_api, defect_dshbrd])
