...
from ltt_ff_frontend.defect_ui import basetrain_api, finetuning_api, inference_api, inference_recipe_api, result_viewer, multilot_inference_api
...
if __name__ == "__main__":
    ...
    pg = st.navigation([page_result_viewer, page_defect_review_gui, page_inference_api, page_inference_recipe_api, page_multilot_inference_api, page_finetuning_api, page_basetrain_api])
