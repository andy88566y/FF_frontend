...
def app() -> None:
    ...
    with feat_use_pooling_col_1:
        feat_use_pooling_1 = st.selectbox(
            label="feat_use_pooling_1", options=[True, False], label_visibility="collapsed", key="feat_use_pooling_1"
        )

    with feat_use_pooling_col_2:
        feat_use_pooling_2 = st.selectbox(
            label="feat_use_pooling_2", options=[True, False], label_visibility="collapsed", key="feat_use_pooling_2"
        )

    with feat_use_pooling_col_3:
        feat_use_pooling_3 = st.selectbox(
            label="feat_use_pooling_3", options=[True, False], label_visibility="collapsed", key="feat_use_pooling_3"
        )
    ...
    with diff_use_pooling_col_1:
        diff_use_pooling_1 = st.selectbox(
            label="diff_use_pooling_1", options=[True, False], label_visibility="collapsed", key="diff_use_pooling_1"
        )

    with diff_use_pooling_col_2:
        diff_use_pooling_2 = st.selectbox(
            label="diff_use_pooling_2", options=[True, False], label_visibility="collapsed", key="diff_use_pooling_2"
        )
