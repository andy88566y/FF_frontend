...
run_dev_defect_ui_v7:
	$(VENV_PREFIX) streamlit run ltt_ff_frontend/run_defect_ui_internal_v7.py --browser.gatherUsageStats false --server.port 8596 --server.address 192.168.201.11
